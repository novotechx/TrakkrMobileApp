...
import com.novotech.trakkr.android.ui.components.ActivityTypeSelector
import com.novotech.trakkr.android.ui.components.SectionLabel
import com.novotech.trakkr.android.ui.components.StartButton
...
)
{
    ...
    Column(modifier = Modifier.fillMaxSize())
    {
        ...
        )
        {
            ...
            {
                SectionLabel("RECENT")
                recentActivities.forEachIndexed
                { index, activity ->
                    TrakkrListItem(
