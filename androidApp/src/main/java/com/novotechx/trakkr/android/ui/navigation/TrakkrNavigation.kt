package com.novotechx.trakkr.android.ui.navigation
...
import com.novotechx.trakkr.android.ui.history.ActivityDetailScreen
import com.novotechx.trakkr.android.ui.history.HistoryScreen
import com.novotechx.trakkr.android.ui.history.StatisticsScreen
import com.novotechx.trakkr.android.ui.onboarding.OnboardingScreen
import com.novotechx.trakkr.android.ui.profile.ProfileScreen
import com.novotechx.trakkr.android.ui.profile.SettingsScreen
import com.novotechx.trakkr.android.ui.routes.RoutesScreen
import com.novotechx.trakkr.android.ui.theme.TrakkrColors
import com.novotechx.trakkr.android.ui.track.ActiveTrackingScreen
import com.novotechx.trakkr.android.ui.track.PreTrackScreen
import com.novotechx.trakkr.android.ui.track.SaveActivityScreen
...
fun TrakkrNavHost(
    ...
    val showNav = currentRoute in screensWithBottomNav && trackingState == TrackingState.IDLE
            ...
            NavHost(
                ...
                composable(Routes.SAVE_ACTIVITY) {
                    SaveActivityScreen(
                        ...
                        onDiscard = { navController.popBackStack(Routes.PRE_TRACK, false) },
                    )
                }
                ...
                composable(Routes.HISTORY) {
                    HistoryScreen(
                        onActivityClick = { id -> navController.navigate(Routes.activityDetail(id)) },
                        onStatsClick = { navController.navigate(Routes.STATISTICS) },
                    )
                }
                ...
                composable(Routes.STATISTICS) {
                    StatisticsScreen(
                        onBack = { navController.popBackStack() },
                        onRecordClick = { id -> navController.navigate(Routes.activityDetail(id)) },
                    )
                }

                composable(Routes.ROUTES) { RoutesScreen() }
